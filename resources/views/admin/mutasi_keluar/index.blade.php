    ...
    <div class="col-xs-12">
      ...
      <div class="box box-success">
        <div class="box-header">
          <h3 class="box-title">Data Mutasi Keluar</h3>
        </div>
        <a href="{{route('mutasi_keluar.create')}}"  style="margin-bottom:20px;margin-left:10px;" class="card-body-title"><button class="btn btn-primary"><i class="fa  fa-plus-square-o"></i> Tambah</button></a>
        <div class="box-body">
