...
@section('title', 'DINDIK | Detail Laporan Mutasi Masuk')
...
<div class="page-header-modern">
  <h1 class="page-title-modern">
    <a href="{{route('laporan_mutasi_masuk.index')}}" class="btn-modern btn-warning-modern"> <i class="fa fa-arrow-circle-left"></i>  Kembali</a> 
