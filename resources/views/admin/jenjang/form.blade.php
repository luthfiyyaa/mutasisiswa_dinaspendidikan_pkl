...
#modal-form .select2-container--default .select2-selection--single:focus,
#modal-form .select2-container--default.select2-container--open .select2-selection--single {
  border-color: #66aaea;
  outline: none;
  box-shadow: 0 0 0 3px rgba(102, 170, 234, 0.1);
}
