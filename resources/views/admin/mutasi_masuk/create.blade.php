  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" role="form" action="{{route('mutasi_masuk.store')}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
          {{method_field('post')}}
          <div class="box-body" style="margin-left:20px;">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="jenjang_id" required id="jenjang_id" class="form-control">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" required name="mutasi_noinduk" id="mutasi_noinduk" placeholder="Nomor Induk">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" required name="mutasi_nisn" id="mutasi_nisn" placeholder="NISN">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" required name="mutasi_tingkat_kelas" id="mutasi_tingkat_kelas" placeholder="Tingkat Kelas">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" required name="mutasi_nama_siswa" id="mutasi_nama_siswa" placeholder="Nama Siswa">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input type="date" max="{{$hari_ini}}" class="form-control" required name="mutasi_tanggal_lahir" id="mutasi_tanggal_lahir" placeholder="Tanggal Lahir">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" required name="mutasi_nama_wali" id="mutasi_nama_wali" placeholder="Nama Wali">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" required name="mutasi_alamat" id="mutasi_alamat" placeholder="Alamat">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" required name="mutasi_sekolah_asal_nama" id="mutasi_sekolah_asal_nama" placeholder="Nama Sekolah Asal">
              </div>
            </div>
