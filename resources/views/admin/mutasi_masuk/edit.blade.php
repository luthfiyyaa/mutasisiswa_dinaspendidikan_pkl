        ...
        <form class="form-horizontal" role="form" action="{{route('mutasi_masuk.update',$mutasi->mutasi_id)}}" method="post" enctype="multipart/form-data">
          ...
          <div class="box-body" style="margin-left:20px;">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" required name="mutasi_sekolah_asal_nama" id="mutasi_sekolah_asal_nama" placeholder="Nama Sekolah Asal" value="{{$mutasi->mutasi_sekolah_asal_nama}}">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" required class="form-control" name="mutasi_sekolah_tujuan_no_surat" id="mutasi_sekolah_tujuan_no_surat" placeholder="Nomor Surat" value="{{$mutasi->mutasi_sekolah_tujuan_no_surat}}">
              </div>
            </div>
