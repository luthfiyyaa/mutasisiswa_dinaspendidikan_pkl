...
class LaporanMutasiMasukController extends Controller
{
    ...
    public function listData()
    {
        ...
        return DataTables::of($mutasi_masuk)
            ...
            ->addColumn('aksi', function ($row) {
                return sprintf(
                    '<a href="%s" class="btn-modern btn-secondary-modern text-center" data-toggle="tooltip" data-placement="bottom" title="Lihat Detail"><i class="fa fa-eye"></i></a>',
    ...
    public function listDataFilter(string $tanggal_awal, string $tanggal_akhir, string $jenjang_id, string $query)
    {
        ...
        return DataTables::of($mutasi_masuk)
            ...
            ->addColumn('aksi', function ($row) {
                return sprintf(
                    '<a href="%s" class="btn-modern btn-secondary-modern" data-toggle="tooltip" data-placement="bottom" title="Lihat Detail"><i class="fa fa-eye"></i></a>',
                    route('laporan_mutasi_masuk.show', $row->mutasi_id)
                );
            })
            ->rawColumns(['aksi'])
